...
urlpatterns = [
    ...
    path('top_level/sub-item_15/sub-item_16', base, {'name': 'Sub-item 16'}, name='Sub-item_16'),
    ...
    path('top_level/sub-item_15/sub-item_16/item_19', base, {'name': 'Item 19'}, name='item_19'),
]
